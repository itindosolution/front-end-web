        ...
        <section className="snap-start w-full pt-10">
            <div className="">
                    <div className="m-auto md:w-2/3">
                            <h3 className="text-center pt-3 text-xl font-bold md:mt-5">Informasi</h3>
                            <div className="flex flex-wrap md:text-center m-4">
                                <div className="w-full md:basis-1/4">
                                    <div>
                                        ...
                                        <p className="text-bold inline-block p-2">085719719528</p>
                                    </div>     
                                </div> 
                                <div className="w-full md:basis-1/4">
                                    <div>
                                        ...
                                        <p className="text-bold inline-block p-2">itindosolution@gmail.com</p>
                                    </div> 
                                </div> 
                                <div className="w-full md:basis-1/4">
                                    <div>
                                        ...
                                        <p className="text-bold inline-block p-2">itindosolution</p>
                                    </div>  
                                </div> 
                                <div className="w-full md:basis-1/4">
                                    <div>
                    ...
                    <div className="bg-slate-300">
                        <p className="text-center p-3">© 2021 Copyright ITINDO SOLUTION</p>
                    </div>
            </div>
        </section>
    )
