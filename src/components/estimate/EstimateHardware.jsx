...
import komputer from "../../assets/image/monitor.webp";
import hp from "../../assets/image/handphone.webp";
...
function SelectionHardware({selectionHardware,setSelectionHardware}){
    ...
    return(
        <div className="flex flex-wrap text-center justify-center">
                    ...
                    selectionHardware ==="pc" ?
                        (
                            <div className="rounded-tl-lg rounded-tr-lg bg-gradient-to-b from-blue-500 to-yellow-300">
                                <img src={komputer} alt="pc" className="m-auto"/>
                            </div>
                        ):
                        (
            ...
            <div className="basis-3/4 mt-1 bg-white rounded-lg border border-gray-200 shadow-xl md:m-3 md:max-w-xs ">
                <div className="rounded-tl-lg rounded-tr-lg bg-gradient-to-b from-blue-500 to-green-300">
                    <img src={laptop} alt="laptop" className="m-auto"/>
                </div>
                <div className="">
                    <a href="s">
            ...
            <div className="basis-3/4 mt-1 bg-white rounded-lg border border-gray-200 shadow-xl md:m-3 md:max-w-xs">
                <div className="rounded-tl-lg rounded-tr-lg bg-gradient-to-b from-blue-500 to-green-300">
                    <img src={hp} alt="hp" className="m-auto"/>
                </div>
                <div className="">
                    <a href="s">
